package shane.blog.domain.common.file;
...
public class FileUtils {
    ...
    // 파일 업로드 경로
    private final String uploadPath = determineRootPath();
    ...
    public static String determineRootPath() {
        ...
        if (os.contains("win")) {
            // Windows
            rootPath = "C:\\"+"develop"+"\\"+"upload-files";
        } else if (os.contains("nix") || os.contains("nux") || os.contains("aix")) {
            // Unix, Linux, or AIX
            rootPath = "/"+ "develop" + "/" + "upload-files";
        } else if (os.contains("mac")) {
            // Mac OS
            rootPath = "/";
        } else {
            // Unknown OS, assuming Unix-like
            rootPath = "/";
        }
