...
function Feedback(props) {
	...
	const updateFeedback = async () => {
		...
		await axiosInstance.patch(`/feedback/${postId}/feedback/update/${feedbackId}`, req, {headers: headers})
		.then((resp) => {
	...
	const deleteFeedback = async () => {
		await axiosInstance.delete(`/feedback/${postId}}/feedback/delete/${feedbackId}`, {headers: headers})
			.then((resp) => {
