...
CREATE DATABASE IF NOT EXISTS `react-spring` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `react-spring`;
...
-- 테이블 데이터 react-spring.tb_employee:~12 rows (대략적) 내보내기
...
INSERT INTO `tb_user` (`MBR_NO`, `ID`, `NAME`) VALUES
